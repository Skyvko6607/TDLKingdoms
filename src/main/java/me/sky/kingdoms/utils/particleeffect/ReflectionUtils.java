...
public final class ReflectionUtils {
	...
	/**
	 * Returns the constructor of a given class with the given parameter interfaces
	 * 
	 * @param clazz Target class
	 * @param parameterTypes Parameter interfaces of the desired constructor
	 * @return The constructor of the target class with the specified parameter interfaces
	 * @throws NoSuchMethodException If the desired constructor with the specified parameter interfaces cannot be found
	 * @see DataType
	...
	public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes) throws NoSuchMethodException {
		...
		throw new NoSuchMethodException("There is no such constructor in this class with the specified parameter interfaces");
	}

	/**
	 * Returns the constructor of a desired class with the given parameter interfaces
	 * 
	 * @param className Name of the desired target class
	 * @param packageType Package where the desired target class is located
	 * @param parameterTypes Parameter interfaces of the desired constructor
	 * @return The constructor of the desired target class with the specified parameter interfaces
	 * @throws NoSuchMethodException If the desired constructor with the specified parameter interfaces cannot be found
	 ...
	 * @throws IllegalArgumentException If the interfaces of the arguments do not match the parameter interfaces of the constructor (this should not occur since it searches for a constructor with the interfaces of the arguments)
	...
	/**
	 * Returns a method of a class with the given parameter interfaces
	 * 
	 * @param clazz Target class
	 * @param methodName Name of the desired method
	 * @param parameterTypes Parameter interfaces of the desired method
	 * @return The method of the target class with the specified name and parameter interfaces
	 * @throws NoSuchMethodException If the desired method of the target class with the specified name and parameter interfaces cannot be found
	 * @see DataType#getPrimitive(Class[])
	 * @see DataType#compare(Class[], Class[])
	 */
	public static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) throws NoSuchMethodException {
		...
		throw new NoSuchMethodException("There is no such method in this class with the specified name and parameter interfaces");
	}

	/**
	 * Returns a method of a desired class with the given parameter interfaces
	 * 
	 * @param className Name of the desired target class
	 * @param packageType Package where the desired target class is located
	 * @param methodName Name of the desired method
	 * @param parameterTypes Parameter interfaces of the desired method
	 * @return The method of the desired target class with the specified name and parameter interfaces
	 * @throws NoSuchMethodException If the desired method of the desired target class with the specified name and parameter interfaces cannot be found
	 * @throws ClassNotFoundException If the desired target class with the specified name and package cannot be found
	 ...
	 * @throws IllegalArgumentException If the interfaces of the arguments do not match the parameter interfaces of the method (this should not occur since it searches for a method with the interfaces of the arguments)
	...
	public enum PackageType {
		...
		CRAFTBUKKIT_INVENTORY(CRAFTBUKKIT, "menu"),
	...
	/**
	 * Represents an enumeration of Java data interfaces with corresponding classes
	 * <p>
	 * This class is part of the <b>ReflectionUtils</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
