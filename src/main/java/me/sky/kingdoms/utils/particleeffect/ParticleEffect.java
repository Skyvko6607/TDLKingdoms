...
public enum ParticleEffect {
	...
	END_ROD("endRod", 43, 9),
	DAMAGE_INDICATOR("damageIndictator", 44, 9),
	...
	public static final class ParticlePacket {
		 ...
		 * 
		 * @param center Center location of the effect
		 * @param range Range in which players will receive the packet (Maximum range for particles is usually 16, but it can differ for some interfaces)
