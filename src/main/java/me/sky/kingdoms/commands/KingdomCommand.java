...
import me.sky.kingdoms.commands.arguments.UpgradeKingdomArgument;
...
public class KingdomCommand implements CommandExecutor, ICommandCategory {
    ...
    public List<ICommandArgument> getCommandArguments() {
        return Arrays.asList(new CreateKingdomArgument(), new JoinKingdomArgument(), new LeaveKingdomArgument(), new UpgradeKingdomArgument(), new ThemeCategory(), new TemplateCategory(), new SchematicCategory());
    }
